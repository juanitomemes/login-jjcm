...
<div class="card">
	<div class="card-header">
        <div class="row">
			<div class="col col-md-6"><b>Editar solicitud</b></div>
	...
	<div class="card-body">
		<form method="post" action="{{ route('applications.update', $application->id) }}" enctype="multipart/form-data">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-10">
					<textarea type="text" name="application_description" class="form-control" rows="3">{{$application->application_description}}</textarea>
				</div>
			</div>
			<div class="row mb-3">
				<label class="col-sm-2 col-label-form">Fecha de solicitud</label>
				<div class="col-sm-10">
            ...
            <div class="row mb-4">
				...
				<div class="col-sm-10">
					...
					<input id="autocomplet_student" name="search" type="text" class="form-control" placeholder="Busca un estudiante..."
...
<script>
document.getElementsByName('student_id')[0].value = "{{ $application->student_id }}";
</script>
